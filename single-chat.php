			  ...
			  if( get_row_layout() == 'btn_choice' ):
			    ...
			    $rowsChoice = get_sub_field('boutons_de_type_choix');
		      	...
		      	$classWrap = '';
					...
					echo '<div class="chat_responses choicerep ' . $classCont . '" id="launch_rep_chat_sequence_' . $a . '_' . $countFlex++ . '">';
		      	echo '<div class="chat_response ' . $classWrap . '">';
			    	...
			    	if( have_rows('boutons_de_type_choix') ):
			    		...
			    		$i = 1;			      
						    ...
						    ?>
								...
								<div class="radio btn <?php echo $classSlide; ?>">
			            <label>
							  ...
							  if( have_rows('next_next_scenario') ):
				    				...
				    				while ( have_rows('next_next_scenario') ) : the_row();
				    					...
				    					if( get_row_layout() == 'btns_choice_next_next' ):
									      ...
									      echo '<div class="chat_responses choicerep seqItem ' . $classCont . '" id="' . $chatRepId . '">';
									      	echo '<div class="chat_response ' . $classWrap . '">';
				    					...
				    					if( get_row_layout() == 'btns_incr_next_next' ):
									      ...
									      if( have_rows('btns_incr_add') ):
									      	if( $countRows > 2 ) {
		    									...
		    									echo '<div class="chat_responses seqItem incrrep" id="launch_rep_chat_sequence_' . $countFlex . '_' . $i . '">';
							        		echo '<div class="chat_response">';
		    									echo '<div class="incr btn">';
			    ...
			    if( have_rows('btns_incr_add') ):
			    	...
			    	if( $countRows > 2 ) {
			      	...
			      	$classWrap = '';
						...
						echo '<div class="chat_responses seqItem incrrep" id="launch_rep_chat_sequence_' . $countFlex . '_' . $a . '">';
        		echo '<div class="chat_response">';
						echo '<div class="incr btn">';
						echo '<div class="' . $classCont . '">';
						echo '<div class="' . $classWrap . '">';
